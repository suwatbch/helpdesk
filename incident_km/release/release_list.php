<?php
    ...
    include_once "release_list.action.php";
...
$(function(){
 ...
 $('.info_link').click(function(event){
    ...
    $("#save_release").click(function(){
        ...
        $("#select_unrelease").val(values);
        page_submit("index.php?action=release_list.php", "save")
        });
    
    $("#search").click(function(){   
        page_submit("index.php?action=release_list.php", "")
        });
});
    ///////////////////////////////////////dropdown///////////////////////////////
 $(document).ready(function () {  
        ...
        $("#cus_company_id").change(function(){
           ...
           page_submit("index.php?action=release_list.php&cus_company_id="+cus_company_id+"&cas_prd_tier_id1="+cas_prd_tier_id1+
