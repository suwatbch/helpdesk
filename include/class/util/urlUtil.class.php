<?php
    class urlUtil {
        public static function getScheme(/*$port is optional*/) {
        ...
        public static function getWebDir($local_dir) {
            $local_dir = self::fix_path($local_dir);
        ...
        public static function resolve_url($relative_url) {
            ...
            $url["path"] = self::resolve_path($url["path"]); //fix this
         ...
         */
        public static function j_parseUrl($url) {
            $r  = "(?:([a-z0-9+-._]+)://)?";
            $r .= "(?:";
            $r .=   "(?:((?:[a-z0-9-._~!$&'()*+,;=:]|%[0-9a-f]{2})*)@)?";
            $r .=   "(?:\[((?:[a-z0-9:])*)\])?";
