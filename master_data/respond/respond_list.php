<?php
    ...
    include_once "respond_list.action.php";
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" style="width:100%;">
    ...
    ?>
        <tr>
                        ...
                        <td align="left"><?=$s_objective["respond_sla"]?></td>
                        <td>
                            <?// if($s_objective['status']=='D'){  ?>
                            <!--<img src="../../images/application_restore.png" id="restore" style="cursor: pointer;" onclick="page_delete('index.php?action=respond_list.php&id_respond=<?=$s_objective["id_respond"]?>', 'restore', 'Do you want restore ?');"/>-->
                            <? // } else { ?>
                            <a href="index.php?action=respond.php&action_master=1&c_id_respond_priority=<?=$s_objective["id_respond_priority"]?>"><img src="../../images/copy.png" style="cursor: pointer;"></a> 
                            <a href="index.php?action=respond.php&action_master=1&id_respond_priority=<?=$s_objective["id_respond_priority"]?>"><img src="../../images/edit_inline.png" style="cursor: pointer;"></a> 
                            <img src="../../images/close_inline.png" id="delete" style="cursor: pointer;" onclick="page_delete('index.php?action=respond_list.php&id_respond_priority=<?=$s_objective["id_respond_priority"]?>', 'delete');"/>
                            <?// } ?>
                        </td>
        </tr>
                 <?php 		
...
<input type="hidden" name="id_respond_priority" id="id_respond_priority"/>
</div>
