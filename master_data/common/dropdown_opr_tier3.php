<?php
    ...
    if (strUtil::isEmpty($company_id)){
		echo dropdown::select('opr_tier_lv3_id', "<option></option>", "style=\"width: 100%;\"");
    } else {
        echo dropdown::loadOpr_tier3_master($db, 'opr_tier_lv3_id', " name=\"opr_tier_lv3_id\" style=\"width: 100%;\"", "", $company_id);
	}
