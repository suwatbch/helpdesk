<?php
    ...
    include_once "org_list.action.php";
...
<script type="text/javascript">
     function validate_delete(){
        $.ajax({
                ...
                data: "action=organization&org_id=" + $("#org_id").val() + "&org_comp=" + $("#company_id").val(),
                success: function(respone){
                    ...
                    if(respone == 1){ 
                        ...
                        page_delete("index.php?action=org_list.php&org_id="+ $("#org_id").val(), 'delete');
                      }
                }
            });
 ...
 <table cellpadding="0" cellspacing="0" border="0" class="display" id="example" style="width:100%;">
    ...
    ?>
        <tr>
                        ...
                        <td align="left"><?=$s_objective["org_name"]?></td>
                        <td>
                            <? //if($s_objective['status']=='D'){  ?>
                            <!--<img src="../../images/application_restore.png" id="restore" style="cursor: pointer;" onclick="page_delete('index.php?action=org_list.php&org_id=<?=$s_objective["org_id"]?>', 'restore', 'Do you want restore ?');"/>-->
                            <? // } else { ?>
                            <a href="index.php?action=org.php&action_master=1&org_id=<?=$s_objective["org_id"]?>"><img src="../../images/edit_inline.png" style="cursor: pointer;"></a> 
<!--                        <img src="../../images/close_inline.png" id="delete" style="cursor: pointer;" onclick="page_delete('index.php?action=org_list.php&org_id=<?=$s_objective["org_id"]?>', 'delete');"/>-->
