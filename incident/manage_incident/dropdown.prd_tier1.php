<?php
    ...
    if (strUtil::isEmpty($cus_company_id)){
		echo dropdown::select("cas_prd_tier_id1", "required=\"true\"<option></option>", "style=\"width: 200px\"");
    } else {
		echo dropdown::loadPrd_tier1($db, "cas_prd_tier_id1", "required=\"true\" style=\"width: 200px;\"", $attr, $cus_company_id);
	}
