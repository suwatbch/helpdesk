    ...
    <body>
        <table width="100%" border="0" cellpadding="0" cellspacing="1">
            ...
            <tr>
                <td>Activity Date</td>
                <td>
                    <?=dateUtil::date_dmy($activity["activity_plan_date"])?>
                     Time
                    <?php
                        if (strUtil::isNotEmpty($activity["start_time"]) && strUtil::isNotEmpty($activity["end_time"])){
                            $d1 = $activity["activity_plan_date"].str_replace(":", "", $activity["start_time"]);
                            $d2 = $activity["activity_plan_date"].str_replace(":", "", $activity["end_time"]);
            ...
            <tr>
                ...
                <td>
                    <?php
                        ...
                        $activity_date = $activity["activity_plan_date"];
