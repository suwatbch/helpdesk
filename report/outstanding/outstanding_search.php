...
<div width="100%">
    <table id="tb_adv_left" width="90%">
        <tr>
            <td width="100%" align="left" margin="5px"><span class="styleGray">รายงานสรุปปัญหา Helpdesk คงเหลือ </span><br><br>
            <input id="result_page" name="result_page" type="hidden" value="outstanding_report.php" />
            </td>
        </tr>
        </table><br>
