...
<html>
    <head>
        ...
        <title>Incident Outstanding Report</title>
        ...
        $(document).ready(function(){
            $('#export_excel').live('click', function() {
               ...
               var url = 'outstanding_export.php' 
                   + '?comp=' + $("#comp").val()
                   + '&start=' + $("#start").val()
                   + '&end=' + $("#end").val()
                   + '&c3=' + $("#c3").val() + '&c3_l=' +  $("#c3_l").val()
                   + '&zone=' + $("#zone").val() + '&zone_l=' + $("#zone_l").val()
                   + '&pj=' + $("#pj").val()
...
//                alert(url);
    ...
    <body>
        <input type="hidden" id="comp" name ="comp" value="<?=$_GET["comp"];?>" />
        <input type="hidden" id="start" name ="start" value="<?=$_GET["start"];?>" />
        <input type="hidden" id="end" name ="end" value="<?=$_GET["end"];?>" />
        <input type="hidden" id="c3" name ="c3" value="<?=$_GET["c3"];?>" />
        <input type="hidden" id="c3_l" name ="c3_l" value="<?=$_GET["c3_l"];?>" />
        <input type="hidden" id="zone" name ="zone" value="<?=$_GET["zone"];?>" />
        <input type="hidden" id="zone_l" name ="zone_l" value="<?=$_GET["zone_l"];?>" />
...
//                        $outst_new = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,'N',$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst_assign = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,"A",$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst_working = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,"W",$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst_pending = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,"P",$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst_resolved = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,"R",$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst_proposeclosed = outstanding_bystatus($comp_id,$start_date,$end_date,$class1_id,$class2_id,$class3_id,"PP",$zone_fr,$zone_to,$project_id,$display_inc);
//                        $outst = $outst_new + $outst_assign + $outst_working + $outst_pending + $outst_resolved + $outst_proposeclosed;
                        if ($total == 0){
                            $pc_outst = 0;
                        }else {
